...
public class PedidoController extends HttpServlet {
	...
	private void atualizarPedido(HttpServletRequest request, HttpServletResponse response, PedidoDAO pedidoDAO) throws ServletException, IOException {
		...
		if (pedidoDAO.atualizarPedido(pedido)) {
			response.getWriter().write("<script>alert('Pedido atualizado com sucesso!'); window.location.href='pedidos.jsp';</script>");
		} else {
			response.getWriter().write("<script>alert('Erro ao atualizar pedido!'); window.location.href='pedidos.jsp';</script>");
		}
	}
